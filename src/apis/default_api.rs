...
pub async fn delete_jwt_refresh(configuration: &configuration::Configuration, application_id: Option<&str>, user_id: Option<&str>, token: Option<&str>, refresh_token_revoke_request: Option<models::RefreshTokenRevokeRequest>) -> Result<(), Error<DeleteJwtRefreshError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_tenant_with_id(configuration: &configuration::Configuration, tenant_id: &str, r#async: Option<&str>, x_fusion_auth_tenant_id: Option<&str>, tenant_delete_request: Option<models::TenantDeleteRequest>) -> Result<(), Error<DeleteTenantWithIdError>> {
    let local_var_configuration = configuration;
...
pub async fn retrieve_report_login(configuration: &configuration::Configuration, application_id: Option<&str>, login_id: Option<&str>, start: Option<&str>, end: Option<&str>, user_id: Option<&str>) -> Result<models::LoginReportResponse, Error<RetrieveReportLoginError>> {
    let local_var_configuration = configuration;
...
pub async fn retrieve_user(configuration: &configuration::Configuration, x_fusion_auth_tenant_id: Option<&str>, change_password_id: Option<&str>, verification_id: Option<&str>, username: Option<&str>, email: Option<&str>, login_id: Option<&str>) -> Result<models::UserResponse, Error<RetrieveUserError>> {
    let local_var_configuration = configuration;
...
pub async fn update_application_with_id(configuration: &configuration::Configuration, application_id: &str, reactivate: Option<&str>, x_fusion_auth_tenant_id: Option<&str>, application_request: Option<models::ApplicationRequest>) -> Result<models::ApplicationResponse, Error<UpdateApplicationWithIdError>> {
    let local_var_configuration = configuration;
...
pub async fn update_user_verify_email(configuration: &configuration::Configuration, email: Option<&str>, send_verify_email: Option<&str>, application_id: Option<&str>) -> Result<models::VerifyEmailResponse, Error<UpdateUserVerifyEmailError>> {
    let local_var_configuration = configuration;
