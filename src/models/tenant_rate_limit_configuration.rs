...
pub struct TenantRateLimitConfiguration {
    ...
    #[serde(rename = "sendPasswordlessPhone", skip_serializing_if = "Option::is_none")]
    pub send_passwordless_phone: Option<Box<models::RateLimitedRequestConfiguration>>,
    #[serde(rename = "sendPhoneVerification", skip_serializing_if = "Option::is_none")]
    pub send_phone_verification: Option<Box<models::RateLimitedRequestConfiguration>>,
...
impl TenantRateLimitConfiguration {
    ...
    pub fn new() -> TenantRateLimitConfiguration {
        TenantRateLimitConfiguration {
            ...
            send_passwordless_phone: None,
            send_phone_verification: None,
