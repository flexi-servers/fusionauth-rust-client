...
pub struct Templates {
    ...
    #[serde(rename = "phoneComplete", skip_serializing_if = "Option::is_none")]
    pub phone_complete: Option<String>,
    #[serde(rename = "phoneSent", skip_serializing_if = "Option::is_none")]
    pub phone_sent: Option<String>,
    #[serde(rename = "phoneVerificationRequired", skip_serializing_if = "Option::is_none")]
    pub phone_verification_required: Option<String>,
    #[serde(rename = "phoneVerify", skip_serializing_if = "Option::is_none")]
    pub phone_verify: Option<String>,
