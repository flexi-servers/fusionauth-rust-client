...
pub struct Application {
    ...
    pub access_control_configuration: Option<Box<crate::models::ApplicationAccessControlConfiguration>>,
    #[serde(rename = "active", skip_serializing_if = "Option::is_none")]
    pub active: Option<bool>,
    #[serde(rename = "authenticationTokenConfiguration", skip_serializing_if = "Option::is_none")]
    pub authentication_token_configuration: Option<Box<crate::models::AuthenticationTokenConfiguration>>,
    #[serde(rename = "cleanSpeakConfiguration", skip_serializing_if = "Option::is_none")]
    pub clean_speak_configuration: Option<Box<crate::models::CleanSpeakConfiguration>>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<::std::collections::HashMap<String, serde_json::Value>>,
    #[serde(rename = "emailConfiguration", skip_serializing_if = "Option::is_none")]
    pub email_configuration: Option<Box<crate::models::ApplicationEmailConfiguration>>,
    #[serde(rename = "externalIdentifierConfiguration", skip_serializing_if = "Option::is_none")]
    pub external_identifier_configuration: Option<Box<crate::models::ApplicationExternalIdentifierConfiguration>>,
    #[serde(rename = "formConfiguration", skip_serializing_if = "Option::is_none")]
    pub form_configuration: Option<Box<crate::models::ApplicationFormConfiguration>>,
    ...
    pub lambda_configuration: Option<Box<crate::models::LambdaConfiguration>>,
    /// The number of milliseconds since the unix epoch: January 1, 1970 00:00:00 UTC. This value is always in UTC.
    ...
    pub login_configuration: Option<Box<crate::models::LoginConfiguration>>,
    #[serde(rename = "multiFactorConfiguration", skip_serializing_if = "Option::is_none")]
    pub multi_factor_configuration: Option<Box<crate::models::ApplicationMultiFactorConfiguration>>,
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "oauthConfiguration", skip_serializing_if = "Option::is_none")]
    pub oauth_configuration: Option<Box<crate::models::OAuth2Configuration>>,
    #[serde(rename = "passwordlessConfiguration", skip_serializing_if = "Option::is_none")]
    pub passwordless_configuration: Option<Box<crate::models::PasswordlessConfiguration>>,
    #[serde(rename = "registrationConfiguration", skip_serializing_if = "Option::is_none")]
    pub registration_configuration: Option<Box<crate::models::RegistrationConfiguration>>,
    #[serde(rename = "registrationDeletePolicy", skip_serializing_if = "Option::is_none")]
    pub registration_delete_policy: Option<Box<crate::models::ApplicationRegistrationDeletePolicy>>,
    #[serde(rename = "roles", skip_serializing_if = "Option::is_none")]
    pub roles: Option<Vec<crate::models::ApplicationRole>>,
    #[serde(rename = "samlv2Configuration", skip_serializing_if = "Option::is_none")]
    pub samlv2_configuration: Option<Box<crate::models::Samlv2Configuration>>,
    ...
    pub unverified: Option<Box<crate::models::RegistrationUnverifiedOptions>>,
    ...
    pub verification_strategy: Option<crate::models::VerificationStrategy>,
    ...
    pub web_authn_configuration: Option<Box<crate::models::ApplicationWebAuthnConfiguration>>,
}
