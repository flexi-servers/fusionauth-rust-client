...
pub struct TenantWebAuthnWorkflowConfiguration {
    ...
    pub authenticator_attachment_preference: Option<crate::models::AuthenticatorAttachmentPreference>,
    #[serde(rename = "userVerificationRequirement", skip_serializing_if = "Option::is_none")]
    pub user_verification_requirement: Option<crate::models::UserVerificationRequirement>,
