...
pub struct JwtConfiguration {
    ...
    pub refresh_token_expiration_policy: Option<crate::models::RefreshTokenExpirationPolicy>,
    #[serde(rename = "refreshTokenRevocationPolicy", skip_serializing_if = "Option::is_none")]
    pub refresh_token_revocation_policy: Option<Box<crate::models::RefreshTokenRevocationPolicy>>,
    #[serde(rename = "refreshTokenSlidingWindowConfiguration", skip_serializing_if = "Option::is_none")]
    pub refresh_token_sliding_window_configuration: Option<Box<crate::models::RefreshTokenSlidingWindowConfiguration>>,
    ...
    pub refresh_token_usage_policy: Option<crate::models::RefreshTokenUsagePolicy>,
