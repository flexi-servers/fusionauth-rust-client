...
pub struct Samlv2Configuration {
    ...
    pub assertion_encryption_configuration: Option<Box<crate::models::Samlv2AssertionEncryptionConfiguration>>,
    ...
    pub initiated_login: Option<Box<crate::models::Samlv2IdPInitiatedLoginConfiguration>>,
    ...
    pub logout: Option<Box<crate::models::Samlv2Logout>>,
    ...
    pub xml_signature_location: Option<crate::models::XmlSignatureLocation>,
