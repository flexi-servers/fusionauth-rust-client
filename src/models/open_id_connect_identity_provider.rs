...
pub struct OpenIdConnectIdentityProvider {
    ...
    pub application_configuration: Option<::std::collections::HashMap<String, crate::models::OpenIdConnectApplicationConfiguration>>,
...
impl OpenIdConnectIdentityProvider {
    /// 
    pub fn new() -> OpenIdConnectIdentityProvider {
        OpenIdConnectIdentityProvider {
            domains: None,
