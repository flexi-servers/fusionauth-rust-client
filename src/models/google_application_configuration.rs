...
pub struct GoogleApplicationConfiguration {
    ...
    pub properties: Option<Box<models::GoogleIdentityProviderProperties>>,
...
impl GoogleApplicationConfiguration {
    /// 
    pub fn new() -> GoogleApplicationConfiguration {
        GoogleApplicationConfiguration {
            button_text: None,
            client_id: None,
            client_secret: None,
