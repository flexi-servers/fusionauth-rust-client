...
pub struct LinkedInIdentityProvider {
    ...
    pub application_configuration: Option<::std::collections::HashMap<String, crate::models::LinkedInApplicationConfiguration>>,
...
impl LinkedInIdentityProvider {
    /// 
    pub fn new() -> LinkedInIdentityProvider {
        LinkedInIdentityProvider {
            button_text: None,
            client_id: None,
            client_secret: None,
