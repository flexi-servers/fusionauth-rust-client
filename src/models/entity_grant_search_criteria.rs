...
/// EntityGrantSearchCriteria : Search criteria for entity grants.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EntityGrantSearchCriteria {
...
impl EntityGrantSearchCriteria {
    /// Search criteria for entity grants.
    pub fn new() -> EntityGrantSearchCriteria {
