...
pub struct ExternalIdentifierConfiguration {
    ...
    #[serde(rename = "loginIntentTimeToLiveInSeconds", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "passwordlessLoginOneTimeCodeGenerator", skip_serializing_if = "Option::is_none")]
    pub passwordless_login_one_time_code_generator: Option<Box<models::SecureGeneratorConfiguration>>,
    ...
    #[serde(rename = "phoneVerificationIdGenerator", skip_serializing_if = "Option::is_none")]
    pub phone_verification_id_generator: Option<Box<models::SecureGeneratorConfiguration>>,
    #[serde(rename = "phoneVerificationIdTimeToLiveInSeconds", skip_serializing_if = "Option::is_none")]
    pub phone_verification_id_time_to_live_in_seconds: Option<i32>,
    #[serde(rename = "phoneVerificationOneTimeCodeGenerator", skip_serializing_if = "Option::is_none")]
    pub phone_verification_one_time_code_generator: Option<Box<models::SecureGeneratorConfiguration>>,
...
impl ExternalIdentifierConfiguration {
    ...
    pub fn new() -> ExternalIdentifierConfiguration {
        ExternalIdentifierConfiguration {
            ...
            login_intent_time_to_live_in_seconds: None,
            one_time_password_time_to_live_in_seconds: None,
            passwordless_login_generator: None,
            passwordless_login_one_time_code_generator: None,
            passwordless_login_time_to_live_in_seconds: None,
            pending_account_link_time_to_live_in_seconds: None,
            phone_verification_id_generator: None,
            phone_verification_id_time_to_live_in_seconds: None,
            phone_verification_one_time_code_generator: None,
