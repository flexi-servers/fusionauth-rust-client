...
pub struct EpicGamesIdentityProvider {
    ...
    pub application_configuration: Option<::std::collections::HashMap<String, crate::models::EpicGamesApplicationConfiguration>>,
