...
pub struct ReactorStatus {
    ...
    pub advanced_identity_providers: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "advancedLambdas", skip_serializing_if = "Option::is_none")]
    pub advanced_lambdas: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "advancedMultiFactorAuthentication", skip_serializing_if = "Option::is_none")]
    pub advanced_multi_factor_authentication: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "advancedRegistration", skip_serializing_if = "Option::is_none")]
    pub advanced_registration: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "applicationMultiFactorAuthentication", skip_serializing_if = "Option::is_none")]
    pub application_multi_factor_authentication: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "applicationThemes", skip_serializing_if = "Option::is_none")]
    pub application_themes: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "breachedPasswordDetection", skip_serializing_if = "Option::is_none")]
    pub breached_password_detection: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "connectors", skip_serializing_if = "Option::is_none")]
    pub connectors: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "entityManagement", skip_serializing_if = "Option::is_none")]
    pub entity_management: Option<crate::models::ReactorFeatureStatus>,
    ...
    pub scim_server: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "threatDetection", skip_serializing_if = "Option::is_none")]
    pub threat_detection: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "webAuthn", skip_serializing_if = "Option::is_none")]
    pub web_authn: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "webAuthnPlatformAuthenticators", skip_serializing_if = "Option::is_none")]
    pub web_authn_platform_authenticators: Option<crate::models::ReactorFeatureStatus>,
    #[serde(rename = "webAuthnRoamingAuthenticators", skip_serializing_if = "Option::is_none")]
    pub web_authn_roaming_authenticators: Option<crate::models::ReactorFeatureStatus>,
}
