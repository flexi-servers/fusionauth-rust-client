...
impl ToString for OAuthErrorReason {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::AccessTokenRequired => String::from("access_token_required"),
            ...
            Self::MissingRequiredScope => String::from("missing_required_scope"),
            Self::UnknownScope => String::from("unknown_scope"),
            Self::ConsentCanceled => String::from("consent_canceled"),
        }
    }
}
