...
/// UserPasswordResetSendEvent : Models the User Password Reset Send Event.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserPasswordResetSendEvent {
...
impl UserPasswordResetSendEvent {
    /// Models the User Password Reset Send Event.
    pub fn new() -> UserPasswordResetSendEvent {
