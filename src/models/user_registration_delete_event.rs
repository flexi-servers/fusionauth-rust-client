...
/// UserRegistrationDeleteEvent : Models the User Delete Registration Event.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserRegistrationDeleteEvent {
...
impl UserRegistrationDeleteEvent {
    /// Models the User Delete Registration Event.
    pub fn new() -> UserRegistrationDeleteEvent {
