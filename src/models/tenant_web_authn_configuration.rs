...
pub struct TenantWebAuthnConfiguration {
    ...
    pub bootstrap_workflow: Option<Box<crate::models::TenantWebAuthnWorkflowConfiguration>>,
    #[serde(rename = "debug", skip_serializing_if = "Option::is_none")]
    pub debug: Option<bool>,
    #[serde(rename = "reauthenticationWorkflow", skip_serializing_if = "Option::is_none")]
    pub reauthentication_workflow: Option<Box<crate::models::TenantWebAuthnWorkflowConfiguration>>,
