...
/// TwitchIdentityProvider : Twitch gaming login provider.



#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TwitchIdentityProvider {
    ...
    pub application_configuration: Option<::std::collections::HashMap<String, crate::models::TwitchApplicationConfiguration>>,
...
impl TwitchIdentityProvider {
    /// Twitch gaming login provider.
    pub fn new() -> TwitchIdentityProvider {
