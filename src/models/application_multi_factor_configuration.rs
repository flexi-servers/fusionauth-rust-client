...
pub struct ApplicationMultiFactorConfiguration {
    ...
    pub email: Option<Box<crate::models::MultiFactorEmailTemplate>>,
    ...
    pub sms: Option<Box<crate::models::MultiFactorSmsTemplate>>,
    #[serde(rename = "trustPolicy", skip_serializing_if = "Option::is_none")]
    pub trust_policy: Option<crate::models::ApplicationMultiFactorTrustPolicy>,
}
