...
/// KickstartSuccessEvent : Event to indicate kickstart has been successfully completed.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct KickstartSuccessEvent {
