...
pub struct PublicKeyCredentialCreationOptions {
    ...
    pub authenticator_selection: Option<Box<crate::models::AuthenticatorSelectionCriteria>>,
    ...
    pub extensions: Option<Box<crate::models::WebAuthnRegistrationExtensionOptions>>,
    #[serde(rename = "pubKeyCredParams", skip_serializing_if = "Option::is_none")]
    pub pub_key_cred_params: Option<Vec<crate::models::PublicKeyCredentialParameters>>,
    #[serde(rename = "rp", skip_serializing_if = "Option::is_none")]
    pub rp: Option<Box<crate::models::PublicKeyCredentialRelyingPartyEntity>>,
    #[serde(rename = "timeout", skip_serializing_if = "Option::is_none")]
    pub timeout: Option<i64>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<Box<crate::models::PublicKeyCredentialUserEntity>>,
}
