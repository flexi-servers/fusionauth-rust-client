...
/// User : The global view of a User. This object contains all global information about the user including birth date, registration information  preferred languages, global attributes, etc.
...
pub struct User {
    ...
    pub two_factor: Option<Box<crate::models::UserTwoFactorConfiguration>>,
    #[serde(rename = "memberships", skip_serializing_if = "Option::is_none")]
    pub memberships: Option<Vec<crate::models::GroupMember>>,
    #[serde(rename = "registrations", skip_serializing_if = "Option::is_none")]
    pub registrations: Option<Vec<crate::models::UserRegistration>>,
    /// The number of milliseconds since the unix epoch: January 1, 1970 00:00:00 UTC. This value is always in UTC.
    ...
    pub breached_password_status: Option<crate::models::BreachedPasswordStatus>,
    ...
    pub password_change_reason: Option<crate::models::ChangePasswordReason>,
    ...
    pub username_status: Option<crate::models::ContentStatus>,
