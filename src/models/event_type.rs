...
pub enum EventType {
    ...
    #[serde(rename = "Test")]
    Test,
    #[serde(rename = "UserIdentityVerified")]
    UserIdentityVerified,
    #[serde(rename = "UserIdentityUpdate")]
    UserIdentityUpdate,
...
impl std::fmt::Display for EventType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::UserIdentityVerified => write!(f, "UserIdentityVerified"),
            Self::UserIdentityUpdate => write!(f, "UserIdentityUpdate"),
        }
    }
}
