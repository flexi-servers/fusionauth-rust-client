...
/// GroupMemberRemoveCompleteEvent : Models the Group Member Remove Complete Event.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupMemberRemoveCompleteEvent {
...
impl GroupMemberRemoveCompleteEvent {
    /// Models the Group Member Remove Complete Event.
    pub fn new() -> GroupMemberRemoveCompleteEvent {
