...
pub struct ApplicationWebAuthnConfiguration {
    ...
    pub bootstrap_workflow: Option<Box<crate::models::ApplicationWebAuthnWorkflowConfiguration>>,
    #[serde(rename = "reauthenticationWorkflow", skip_serializing_if = "Option::is_none")]
    pub reauthentication_workflow: Option<Box<crate::models::ApplicationWebAuthnWorkflowConfiguration>>,
