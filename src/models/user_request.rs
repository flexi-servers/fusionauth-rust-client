...
pub struct UserRequest {
    ...
    #[serde(rename = "sendSetPasswordIdentityType", skip_serializing_if = "Option::is_none")]
    pub send_set_password_identity_type: Option<models::SendSetPasswordIdentityType>,
    ...
    #[serde(rename = "verificationIds", skip_serializing_if = "Option::is_none")]
    pub verification_ids: Option<Vec<String>>,
...
impl UserRequest {
    ...
    pub fn new() -> UserRequest {
        UserRequest {
            ...
            send_set_password_identity_type: None,
