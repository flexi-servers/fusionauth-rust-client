...
/// TwitterIdentityProvider : Twitter social login provider.



#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TwitterIdentityProvider {
    ...
    pub application_configuration: Option<::std::collections::HashMap<String, crate::models::TwitterApplicationConfiguration>>,
...
impl TwitterIdentityProvider {
    /// Twitter social login provider.
    pub fn new() -> TwitterIdentityProvider {
