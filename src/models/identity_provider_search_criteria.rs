...
/// IdentityProviderSearchCriteria : Search criteria for Identity Providers.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IdentityProviderSearchCriteria {
...
impl IdentityProviderSearchCriteria {
    /// Search criteria for Identity Providers.
    pub fn new() -> IdentityProviderSearchCriteria {
