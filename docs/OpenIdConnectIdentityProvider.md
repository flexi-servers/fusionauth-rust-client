...
**application_configuration** | Option<[**std::collections::HashMap<String, models::OpenIdConnectApplicationConfiguration>**](OpenIdConnectApplicationConfiguration.md)> |  | [optional]
