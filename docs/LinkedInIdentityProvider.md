...
**application_configuration** | Option<[**::std::collections::HashMap<String, crate::models::LinkedInApplicationConfiguration>**](LinkedInApplicationConfiguration.md)> |  | [optional]
