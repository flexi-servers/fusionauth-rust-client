...
**application_configuration** | Option<[**::std::collections::HashMap<String, crate::models::GoogleApplicationConfiguration>**](GoogleApplicationConfiguration.md)> |  | [optional]
