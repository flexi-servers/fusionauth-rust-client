...
**properties** | Option<[**models::GoogleIdentityProviderProperties**](GoogleIdentityProviderProperties.md)> |  | [optional]
**scope** | Option<**String**> |  | [optional]
**data** | Option<[**std::collections::HashMap<String, serde_json::Value>**](serde_json::Value.md)> |  | [optional]
**application_configuration** | Option<[**std::collections::HashMap<String, models::GoogleApplicationConfiguration>**](GoogleApplicationConfiguration.md)> |  | [optional]
