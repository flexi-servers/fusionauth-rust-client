...
**application_configuration** | Option<[**::std::collections::HashMap<String, crate::models::TwitchApplicationConfiguration>**](TwitchApplicationConfiguration.md)> |  | [optional]
