...
**application_configuration** | Option<[**::std::collections::HashMap<String, crate::models::SonyPsnApplicationConfiguration>**](SonyPSNApplicationConfiguration.md)> |  | [optional]
