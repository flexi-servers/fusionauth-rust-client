...
**application_configuration** | Option<[**::std::collections::HashMap<String, crate::models::FacebookApplicationConfiguration>**](FacebookApplicationConfiguration.md)> |  | [optional]
