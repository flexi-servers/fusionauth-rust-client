...
**application_configuration** | Option<[**std::collections::HashMap<String, models::EpicGamesApplicationConfiguration>**](EpicGamesApplicationConfiguration.md)> |  | [optional]
